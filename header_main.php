...
<body>
	<div class="container">
		...
		<div class="top-buttons btn-group">
			<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Students <span class="caret"></span></button>
		  	<ul class="dropdown-menu" role="menu">	
		  		<li><a href="customer-add.php">Add Students</a></li>	    
				<li><a href="customer-list.php">Manage Students</a></li>
		  	</ul>
		</div>
